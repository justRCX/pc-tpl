...
var CNPrint_CNPrint = /*#__PURE__*/function () {
  ...
  _createClass(CNPrint, [{
    ...
    value: function initSocket() {
      var _this = this; //如果是https的话，端口是13529
          ...
          switch (data.cmd) {
            ...
            case 'print':
              if (data.status === 'success') {
                // 请求调取后台接口,打印回调
                _this.printSuccessCb && _this.printSuccessCb();
              } else {
                console.log(data);
    ...
    value: function getData(dataArr) {
      ...
      return dataArr.map(function (item) {
        var documentID = _this2.getUniId(); // 自定义模板打印要保证documentID唯一
...
var components = [common_header, MZText, MZWhite, PicAD, Goods, coupon_List, coupon_List_couponListChoose, c_img, img_content_agent, img_content_pc, choose_list, pager];
...
console.log(CNPrint_CNPrint, /aaa/);
